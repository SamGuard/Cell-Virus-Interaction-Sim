...
double CELL_DEATH_LENGTH, CELL_DIVIDE_PROB, CELL_BYSTANDER_DEATH_PROB,
    ...
    CELL_TO_BYSTANDER_PROB, CELL_BYSTANDER_INFECT_SKIP_PROB,
    CELL_CHANCE_TO_SPAWN_VIRUS, CELL_INFECT_NEIGH_CELL_PROB;
...
ParameterConfig::ParameterConfig(repast::Properties *props) {
    ...
    VIRUS_INFECT_PROB =
        std::stod(props->getProperty("VIRUS_INFECT_PROB"));
